...
A study library on interface craft: 136 lessons across Craft, Typography, Color, Layout, Motion, UX and Primitives, plus a References section. Every lesson has a live, hands-on demo (sliders and switches, no play buttons), "details that make the difference", and sources.
...
- `craft.html`, `typography.html`, `color.html`, `layout.html`, `motion.html`, `ux.html`, `primitives.html`, `references.html` — sections (EN)
